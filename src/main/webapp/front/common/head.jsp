...
<div class="head_container">
	<div class="head_welcome">
		...
		<b>您好，尊敬的${sessionScope.login.nickname}欢迎光临当当网</b>
		<c:if test="${sessionScope.login!=null }">
		[&nbsp;<a href="${pageContext.request.contextPath}/frontuser/fu_exit" class="b">登出</a>&nbsp;]
		</c:if>
		<c:if test="${sessionScope.login==null}">
	...
	<div class="head_head_list">
		<div class="head_head_list_left">
			<span class="head_logo">
				<a href="${pageContext.request.contextPath}/frontbook/fb_main'" name="backtobook">
