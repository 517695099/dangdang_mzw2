...
<html>
	...
	<body style="background-color: #f0f9fd;text-align: center;">
		...
		<div style="margin-bottom: 10px;">
			...
			<div class="button btn-p" onclick="location.href='${pageContext.request.contextPath}/category/query_catchFirst'">添加二级类别&raquo;</div>
		</div>
		...
		<table bordercolor='#898E90' align='center' border='3px' cellpadding='10px' cellspacing="0px" >
			...
			<tr>
				...
				<td>${cat.levels}</td>
				<td>
					<div class="button" onclick="location.href='${pageContext.request.contextPath}/category/query_deleteCategory?category.id=${cat.id}&category.levels=${cat.levels}' ">删除 &raquo;</div>	
				</td>
			</tr>	
			</c:forEach>
		</table><br/>	
